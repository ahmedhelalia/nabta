...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const botResponses = {
        ...
        family_issues: {
            ...
            responses: [
                'أتفهم ما تمر به، والمشاكل الأسرية طبيعية في كل بيت. المهم هو كيفية التعامل معها بحكمة. يمكنك التحدث مع أحد مستشارينا المتخصصين <a href="consultations.php">احجز استشارة الآن</a>',
                'لا تقلق، معظم العائلات تواجه تحديات. نحن هنا لمساعدتك في إيجاد حلول عملية. خبراؤنا متخصصون في حل المشكلات الأسرية <a href="consultations.php#experts-section">اختر مستشارك</a>',
        ...
        courses: {
            ...
            responses: [
                'ممتاز! التعلم المستمر مفتاح النجاح في الحياة الأسرية.  نقدم دورات متخصصة في التطوير الأسري والزوجي <a href="courses.php">تصفح دوراتنا</a>',
                'الاستثمار في تطوير الذات والمهارات الأسرية استثمار رائع! اكتسب مهارات جديدة مع دوراتنا التدريبية المتخصصة <a href="courses.php">اكتشف الدورات المتاحة</a>',
        ...
        psychological: {
            ...
            responses: [
                'الصحة النفسية أساس الحياة السعيدة والأسرة المستقرة.  يمكنك استشارة متخصصينا النفسيين <a href="consultations.php">من هنا</a>',
                'اهتمامك بصحتك النفسية خطوة مهمة جداً. نقدم دعماً نفسياً متخصصاً للأزواج والعائلات <a href="consultations.php#experts-section">تحدث مع مستشارينا</a>',
        ...
        community: {
            ...
            responses: [
                'المجتمع قوة!  شارك تجاربك واستفد من تجارب الآخرين في <a href="community.php">منتدى نبتة</a>',
                'التعلم من تجارب الآخرين يثري خبراتك الشخصية. انضم لمجتمعنا الداعم <a href="community.php">زر المنتدى</a>',
    ...
    function getIntelligentFallback(message) {
        ...
        if (conversationContext.messageCount > 3 && 
            ...
            return 'أعتذر للالتباس!  دعني أساعدك بطريقة أفضل. يمكنك التواصل مباشرة مع أحد مستشارينا <a href="consultations.php">من هنا</a> أو تصفح أقسام الموقع الرئيسية للحصول على المعلومات التي تحتاجها.';
        }
